...
public interface InterProduct {
    /*
    * 인터페이스는 상수 필드만 작성 가능
    * public static final -> 조합을 상수필드라고 함 -> 선언과 동시에 초기화해야함
    *
    */

    // public static final int a = 0;

    // public static final 이 숨어 있음
    int MIN_NUM = 10;
    int MAX_NUM = 100;
    // 생성자를 가질 수 없음
    // public InterProduct(){} --> 오류 발생

    // 인터페이스는 구현부가 있는 메서드를 가질 수 없다.
    // public void nonStaticMethod(){}  --> 오류 발생
    ...
    * 인터페이스를 상속받는 클래스는 메소드를 구현할 때,
    * 접근제어자를 public 으로 해야지 구현 가능함
    */
    void abstMethod();



    // staic 메서드는 가질 수 있음 (java 8버전 이후)
