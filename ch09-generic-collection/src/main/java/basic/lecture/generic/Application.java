...
public class Application {
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        gt2.setValue(10); // 10(int 값)이 Integer로 오토박싱 된다.
        // gt2.getValue(). <-- 참조 연산자 찍어서 확인 가능
        System.out.println(gt2.getValue());
        System.out.println(gt2.getValue() instanceof Integer); // 타입 맞는지 확인하는 연산자 : instance of
